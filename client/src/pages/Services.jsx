...
export default function Services() {
  const services = [
    ...
    },
    {
      image: affiliate,
      title: "Affiliate and Influencer Marketing",
      description: "Partnering with affiliates or influencers to promote products/services, driving reach and conversions through trusted voices."
    },
    {
      image: offline,
      title: "Online and Offline Marketing",
      description: "Blending traditional offline strategies with online channels to reach customers seamlessly across multiple touchpoints."
    },
    {
      image: realEstate,
      title: "Real Estate Marketing",
      description: "Tailored strategies to promote properties through digital campaigns, virtual tours, and offline presence to attract buyers effectively."
    },
    {
      image: mobileApp,
      title: "Mobile Application Development",
